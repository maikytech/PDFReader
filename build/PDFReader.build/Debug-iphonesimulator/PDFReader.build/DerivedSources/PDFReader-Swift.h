...
SWIFT_CLASS("_TtC9PDFReader11AppDelegate")
...
SWIFT_CLASS("_TtC9PDFReader13SceneDelegate")
...
SWIFT_CLASS("_TtC9PDFReader14ViewController")
...
SWIFT_CLASS("_TtC9PDFReader15ViewController2")
@interface ViewController2 : UIViewController
@property (nonatomic, strong) IBOutlet WKWebView * _Null_unspecified WebViewPDF;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
